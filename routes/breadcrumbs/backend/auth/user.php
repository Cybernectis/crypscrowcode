...
Breadcrumbs::register('admin.auth.user.view.trades', function ($breadcrumbs, $id) {
    $breadcrumbs->parent('admin.auth.user.index');
    $breadcrumbs->push(__('menus.backend.access.users.viewtrades'), route('admin.auth.user.view.trades', $id));
});