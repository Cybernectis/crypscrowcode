...
trait PaymentMethodAttribute
{
    ...
    {
        return '<a href="'.route('admin.auth.payments.edit', $this).'" class="btn btn-primary"><i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="'.__('buttons.general.crud.edit').'"></i></a>';
    }
    ...
    {
        return '<a href="'.route('admin.auth.payments.destroy', $this).'"
             data-method="delete"
