...
trait UserAttribute
{
     ...
     * @return string
     */
    public function getTradesButtonAttribute()
    {
        return '<a href="'.route('admin.auth.user.view.trades', $this).'"  class="dropdown-item">'.__('buttons.backend.access.users.view_trades').'</a> ';
    }
    /**
     * @return string
     */
