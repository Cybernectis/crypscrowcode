    ...
    */
    ...
    'backend' => [
        'access' => [
            ...
            'exchange' => [
                'already_exists'    => 'That exchangerate already exists. Please choose a different name.',
                'cant_delete_admin' => 'You can not delete the Administrator role.',
                'create_error'      => 'There was a problem creating this exchangerate. Please try again.',
                'delete_error'      => 'There was a problem deleting this exchangerate. Please try again.',
                'not_found'         => 'That exchangerate does not exist.',
                'update_error'      => 'There was a problem updating this exchangerate. Please try again.',
            ],
            'localcoins' => [
                'already_exists'    => 'That localcoin already exists. Please choose a different name.',
                'cant_delete_admin' => 'You can not delete the Administrator role.',
                'create_error'      => 'There was a problem creating this localcoin. Please try again.',
                'delete_error'      => 'There was a problem deleting this localcoin. Please try again.',
                'has_users'         => 'You can not delete a localcoin with associated users.',
                'needs_permission'  => 'You must select at least one permission for this localcoin.',
                'not_found'         => 'That localcoin does not exist.',
                'update_error'      => 'There was a problem updating this localcoin. Please try again.',
            ],
            'users' => [
