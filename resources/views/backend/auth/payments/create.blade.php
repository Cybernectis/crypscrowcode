...
@section ('title', __('labels.backend.access.payments.management') . ' | ' . __('labels.backend.access.payments.create'))

@section('content')
{{ html()->form('POST', route('admin.auth.payments.store'))->class('form-horizontal')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">{{ __('labels.backend.access.payments.create') }}</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
