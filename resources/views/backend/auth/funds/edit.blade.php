...
@section ('title', __('labels.backend.access.funds.management') . ' | ' . __('labels.backend.access.funds.edit'))

@section('content')
{{ html()->modelForm($funds, 'PATCH', route('admin.auth.funds.update', $funds->id))->class('form-horizontal')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">{{ __('labels.backend.access.funds.edit') }}</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
            <!--row-->
