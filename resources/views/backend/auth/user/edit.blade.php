            ...
            <div class="row mt-4 mb-4">
                <div class="col">
                    ...
                    <div class="form-group row">
                        ...
                        <label for="gender" class="col-md-2 form-control-label">Gender</label>
                        
                        <div class="col-md-10">
                            <input type="radio" name="gender" value="male" required {{ $user->gender == 'male' ? 'checked' : '' }}>Male
                            <input type="radio" name="gender" value="female" required {{ $user->gender == 'female' ? 'checked' : '' }}>Female
