...
@section ('title', __('labels.backend.access.localcoins.management') . ' | ' . __('labels.backend.access.localcoins.create'))

@section('content')
{{ html()->form('POST', route('admin.auth.localcoins.store'))->class('form-horizontal')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">{{ __('labels.backend.access.localcoins.create') }}</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
